            ...
            return (
              <div className="Row__Container_media">
                ...
                <div className="Row__JoinButtonDiv_m">
                  <a className={(button_status == 0) ? "Row__JoinButton_Off_m" : "Row__JoinButton_m"} href={join_link} target="_blank" title={(button_status == 1) ? "This is a general link for " + class_name + " class. Do not depend completely on this link." : null}>{class_name == "CMOS / CAO / ESD" || class_name == "Algorithms" ? "Check Group" : "Join Now"}</a>
                </div>
              </div>
          );
      }
