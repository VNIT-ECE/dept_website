      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between rounded-3xl shadow-md">
        ...
        <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
          ...
          <div className="inline-flex rounded-md shadow">
            <a
              href={join_link}
              className={(button_status === 0) ? "text-3xl  text-white sm:text-3xl inline-flex items-center justify-center px-5 py-3 border border-transparent text-base  rounded-md text-white bg-gray-400 hoverbg-gray-400" : "text-3xl  text-white sm:text-3xl inline-flex items-center justify-center px-5 py-3 border border-transparent text-base  rounded-md text-white bg-teal-accent-700 hover:bg-teal-500 text-white"}
              target="_blank"
            >
